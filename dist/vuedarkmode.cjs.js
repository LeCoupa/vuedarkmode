...
var script$3 = {
  ...
  methods: {
    ...
    onDoubleClick: function onDoubleClick(id, event) {
      this.$emit("dblclick", id, event);
    },
    onMouseDown: function onMouseDown(id, event) {
      this.$emit("mousedown", id, event);
    },
    onMouseEnter: function onMouseEnter(id, event) {
      this.$emit("mouseenter", id, event);
    },
    onMouseLeave: function onMouseLeave(id, event) {
      this.$emit("mouseleave", id, event);
    },
    onMouseMove: function onMouseMove(id, event) {
      this.$emit("mousemove", id, event);
    },
    onMouseOut: function onMouseOut(id, event) {
      this.$emit("mouseout", id, event);
    },
    onMouseOver: function onMouseOver(id, event) {
      this.$emit("mouseover", id, event);
    },
    onMouseUp: function onMouseUp(id, event) {
    ...
    "button",
    {
      ...
      on: {
        ...
        dblclick: function($event) {
          _vm.onDoubleClick(_vm.id, $event);
        },
        mousedown: function($event) {
          _vm.onMouseDown(_vm.id, $event);
        },
        mouseenter: function($event) {
          _vm.onMouseEnter(_vm.id, $event);
        },
        mouseleave: function($event) {
          _vm.onMouseLeave(_vm.id, $event);
        },
        mousemove: function($event) {
          _vm.onMouseMove(_vm.id, $event);
        },
        mouseout: function($event) {
          _vm.onMouseOut(_vm.id, $event);
        },
        mouseover: function($event) {
          _vm.onMouseOver(_vm.id, $event);
        },
        mouseup: function($event) {
          _vm.onMouseUp(_vm.id, $event);
        }
      }
    },
    [
...
var script$7 = {
  ...
  methods: {
    // --> EVENT LISTENERS <--
    onClick: function onClick(network, event) {
