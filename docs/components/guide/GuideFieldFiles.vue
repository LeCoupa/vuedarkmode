      ...
      props: {
        ...
        data: [
          ...
          },
          {
            ...
            details: {
              description:
                "Specify the validation rules for the file element (check <a href='https://logaretm.github.io/vee-validate/api/rules.html' target='_blank'>VeeValidate documentation</a>)."
            }
          },
          {
            name: "rules-name",
