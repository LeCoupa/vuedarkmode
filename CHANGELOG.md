...
- BaseHeading: type prop now accepts "small" when you need to display smaller content. Type prop has been renamed in tag as it is more explicit. The uppercase prop has been added.
